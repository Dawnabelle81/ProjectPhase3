...
def printinfo(DetailsPrinted):
    ...
    TotNetPay = 0.00
#***************************************************************************************************************************
    # write the line of code that will opent eh file in read mode and assign it to EmpFile (Hint: see week6, lab 2 as a guide)
    with open(FILENAME, "r") as EmpFile:
        ...
        while True:
            ...
            # write the if statement that will break out the while loop when no data is left in the file
            if not EmpDetail:
                break
...
if __name__ == "__main__":
        # write the the line code that will open the file in append and assign it to the EmpFile (Hint: see week 6, lab 2 as a guide)
        with open(FILENAME, "a") as EmpFile:
            ...
            while True:
                ...
                # write the line of code that wil write EmpDetail to the file
